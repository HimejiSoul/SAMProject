...
const Header = () => {
  ...
  return (
    <>
      <header
        className={`header left-0 top-0 z-40 flex w-full items-center font-bold ${
          sticky
            ...
            <div className=" flex w-full flex-row items-center justify-between ">
              <div className="flex flex-row items-center justify-between">
                <div className="px-7 text-sm">
                  <Link href="/" className="text-[#FF9940]">
                    ID
                  </Link>
                  <span className="text-[#3C5896]"> | </span>
                  <Link href="/" className="text-[#3C5896] opacity-50">
                    ENG
                  </Link>
                </div>
                <button
                ...
                >
                  <ul className="block px-7 text-sm lg:flex lg:space-x-12">
                        ...
                        {menuItem.path ? (
                          ...
                          <>
                            <p
                              ...
                              className="flex cursor-pointer items-center justify-between py-2 text-[#3C5896] group-hover:text-[#FF9940]  lg:mr-0 lg:inline-flex lg:px-0 lg:py-6"
                            >
                              {menuItem.title}
                            </p>
                            <div
                            ...
                            >
                              {menuItem.submenu.map((submenuItem, index) => (
                                <Link
                                  ...
                                  key={index}
                                  className="block rounded py-2.5 text-sm text-[#3C5896]  hover:text-[#FF9940] lg:px-3"
                                >
                                  {submenuItem.title}
                                </Link>
                              ))}
